import type { Hex } from "@kollectyve/sdk";

// The sample Storage contract from kollectyve-chain/contracts, compiled with solc 0.8.28
// (evmVersion cancun). ABI + creation bytecode embedded so the pilot can deploy it directly
// via MetaMask — no separate Hardhat step.
